...
const SHELL = ["./", "./index.html", "./manifest.webmanifest", "./icons/icon-192.png", "./icons/icon-512.png",
  ...
  "./features/vehicles-data.js", "./features/vehicles.js", "./features/cluster.js", "./features/stats.js", "./features/speedlimit.js", "./features/autoview.js", "./features/usage.js",
...
self.addEventListener("fetch", e => {
  ...
  if (url.hostname.endsWith("goatcounter.com")) return;          // kullanım sayacı: önbelleğe girmez
